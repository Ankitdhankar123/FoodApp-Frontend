...
export class FoodOrderService {
  ...
  registerFoodOrder(foodOrder:any,itemId:any,staffId:any) {
    return this.http.post(`http://localhost:8080/savefoodOrder?items=${itemId}&staffId=${staffId}`,foodOrder);
  }
  //Update Food Order
  updateFoodOrder(id:any, itemId:any, foodOrder:any) {
    return this.http.put(`http://localhost:8080/updatefoodOrder?items=${itemId}&id=${id}`,foodOrder);
  }
  //Delete Food Order
